...
<h1 class="text-center fs-1 fw-bolder"><img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle"> Seguimiento de Cierre N&deg <?php echo "$Codigo ";?><img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle"></h1><br><br>
...
<table><center><tr>
	...
	<td>
	    <Form Action="CierreReclamo.php" Method="Post">
