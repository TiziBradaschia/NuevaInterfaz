...
?>
	<font color="magenta" size="5px"><?php echo"$Nombre"?> Dni n&deg <?php echo"$Dni"?><br>
	 <br><h2 align="left">Detalle del Reclamo</h2>
	<table >
...
?>
			...
			<tr><td align='left'><font color='#FAE5D3' size='4'><b>Descripci&oacuten: </td>
	            <td><textarea class="form-control" name="Observaciones" rows="4"><?php echo"$D"?></textarea></td>
		    </tr></table>
<?php
...
?>
<table><tr>
	 <td><button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="check-double" type="solid" size="lg" color="#FAE5D3" animation="tada"></box-icon>  Actualizar</button></form></td>
